...
public class ItemBlockWoodenSlab1MP extends ItemBlockBaseMP
{
	private BlockWoodenSlab1MP singleSlab;
	private BlockDoubleWoodenSlab1MP doubleSlab;
	...
	{
		return new String[] { "ancient_dark_wood", "orange_wood", "crystal_wood", "coconut_wood", "maple_wood" };
	}
}