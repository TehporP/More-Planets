...
//		CompressorRecipes.addShapelessRecipe(new ItemStack(DionaItems.tier4_rocket_module, 1, 1), new ItemStack(AsteroidsItems.basicItem, 1, 0), new ItemStack(AsteroidsItems.basicItem, 1, 6));
//		CompressorRecipes.addShapelessRecipe(new ItemStack(DionaItems.diona_item, 1, 4), new ItemStack(DionaItems.tier4_rocket_module, 1, 1), new ItemStack(DionaItems.diona_item, 1, 3), new ItemStack(DionaItems.diona_item, 1, 2));
//
...
//		CompressorRecipes.addShapelessRecipe(new ItemStack(PolongniusItems.tier6_rocket_module, 1, 2), new ItemStack(PolongniusItems.polongnius_item, 1, 7), new ItemStack(PolongniusItems.polongnius_item, 1, 6), new ItemStack(DionaItems.diona_item, 1, 4));
//
...
//		CompressorRecipes.addShapelessRecipe(new ItemStack(NibiruItems.tier7_rocket_module, 1, 2), new ItemStack(PolongniusItems.tier6_rocket_module, 1, 2), new ItemStack(NibiruItems.nibiru_item, 1, 3), new ItemStack(NibiruItems.nibiru_item, 1, 2));
//
...
//		CompressorRecipes.addShapelessRecipe(new ItemStack(FronosItems.tier8_rocket_module, 1, 2), new ItemStack(FronosItems.fronos_item, 1, 4), new ItemStack(FronosItems.fronos_item, 1, 5), new ItemStack(NibiruItems.tier7_rocket_module, 1, 2));
//
