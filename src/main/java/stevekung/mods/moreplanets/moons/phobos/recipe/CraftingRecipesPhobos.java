...
public class CraftingRecipesPhobos
{
	...
	{
		FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PhobosBlocks.phobos_block, 1, 3), new ItemStack(PhobosBlocks.phobos_block, 1, 2), 0.5F);
	}

	private static void addItemSmelting()
	{
		//FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PhobosBlocks.phobos_block, 1, 4), new ItemStack(GCItems.basicItem, 1, 4), 0.7F);
		//FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PhobosBlocks.phobos_block, 1, 5), new ItemStack(GCItems.basicItem, 1, 3), 0.7F);
		FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PhobosBlocks.phobos_block, 1, 6), new ItemStack(Items.iron_ingot), 0.8F);
		//FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PhobosBlocks.phobos_block, 1, 7), new ItemStack(MarsItems.marsItemBasic, 1, 2), 0.8F);
	}
}