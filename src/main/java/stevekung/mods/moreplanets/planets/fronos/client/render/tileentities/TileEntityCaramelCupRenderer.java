...
{
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/cup/caramel.png");
	private ModelFilledCup cup = new ModelFilledCup();

	public void renderTile(TileEntityCaramelCup cup, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntityCaramelCup)tile, posX, posZ, par4, par6);
	}
}