...
public class TileEntityCavernOysterCloseRenderer extends TileEntitySpecialRenderer
{
	...
	public void renderTile(TileEntityCavernOysterClose oyster, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntityCavernOysterClose)tile, posX, posZ, par4, par6);
	}
}