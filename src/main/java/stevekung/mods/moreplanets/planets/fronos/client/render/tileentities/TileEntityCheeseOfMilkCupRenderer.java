...
{
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/cup/cheese_of_milk.png");
	private ModelFilledCup cup = new ModelFilledCup();

	public void renderTile(TileEntityCheeseOfMilkCup cup, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntityCheeseOfMilkCup)tile, posX, posZ, par4, par6);
	}
}