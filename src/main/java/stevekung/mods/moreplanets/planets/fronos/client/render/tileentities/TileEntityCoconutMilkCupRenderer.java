...
{
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/cup/coconut_milk.png");
	private ModelFilledCup cup = new ModelFilledCup();

	public void renderTile(TileEntityCoconutMilkCup cup, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntityCoconutMilkCup)tile, posX, posZ, par4, par6);
	}
}