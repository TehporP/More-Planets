...
import stevekung.mods.moreplanets.planets.fronos.client.model.ModelEmptyCup;
...
{
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/cup/tea.png");
	private ModelEmptyCup cup = new ModelEmptyCup();

	public void renderTile(TileEntityCup cup, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntityCup)tile, posX, posZ, par4, par6);
	}
}