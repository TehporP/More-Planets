...
{
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/cup/ovantine.png");
	private ModelFilledCup cup = new ModelFilledCup();

	public void renderTile(TileEntityOvantineCup cup, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntityOvantineCup)tile, posX, posZ, par4, par6);
	}
}