...
import stevekung.mods.moreplanets.planets.fronos.client.model.ModelOysterClose;
...
{
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/oyster/default.png");
	private ModelOysterClose oyster = new ModelOysterClose();

	public void renderTile(TileEntitySpaceOysterClose oyster, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntitySpaceOysterClose)tile, posX, posZ, par4, par6);
	}
}