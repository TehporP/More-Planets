...
public class TileEntitySpaceOysterOpenRenderer extends TileEntitySpecialRenderer
{
	...
	public void renderTile(TileEntitySpaceOysterOpen oyster, double par2, double par3, double par4, int par5)
	{
		int meta;
	...
	{
		this.renderTile((TileEntitySpaceOysterOpen)tile, posX, posZ, par4, par6);
	}
}