...
public class TileEntityKapteynBAncientChestRenderer extends TileEntitySpecialRenderer
{
	...
	private ResourceLocation textureNormalDouble = new ResourceLocation("moreplanets:textures/model/kapteyn_b_ancient_chest_double.png");
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/kapteyn_b_ancient_chest.png");
	...
	public void func_180538_a(TileEntityKapteynBAncientChest chest, double p_180538_2_, double p_180538_4_, double p_180538_6_, float p_180538_8_, int p_180538_9_)
	{
		...
		else
		{
			...
			if (block instanceof BlockKapteynBAncientChest && j == 0)
			{
	...
	{
		this.func_180538_a((TileEntityKapteynBAncientChest)p_180535_1_, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
	}
}