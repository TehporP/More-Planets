...
public class TileEntityMercuryAncientChestRenderer extends TileEntitySpecialRenderer
{
	...
	private ResourceLocation textureNormalDouble = new ResourceLocation("moreplanets:textures/model/mercury_ancient_chest_double.png");
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/mercury_ancient_chest.png");
	...
	public void func_180538_a(TileEntityMercuryAncientChest chest, double p_180538_2_, double p_180538_4_, double p_180538_6_, float p_180538_8_, int p_180538_9_)
	{
		int j;
		...
		else
		{
			...
			if (block instanceof BlockMercuryAncientChest && j == 0)
			{
				((BlockMercuryAncientChest)block).checkForSurroundingChests(chest.getWorld(), chest.getPos(), chest.getWorld().getBlockState(chest.getPos()));
				j = chest.getBlockMetadata();
			}
	...
	{
		this.func_180538_a((TileEntityMercuryAncientChest)p_180535_1_, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
	}
}