...
public class TileEntityPlutoAncientChestRenderer extends TileEntitySpecialRenderer
{
	...
	private ResourceLocation textureNormalDouble = new ResourceLocation("moreplanets:textures/model/pluto_ancient_chest_double.png");
	private ResourceLocation textureNormal = new ResourceLocation("moreplanets:textures/model/pluto_ancient_chest.png");
	...
	public void func_180538_a(TileEntityPlutoAncientChest chest, double p_180538_2_, double p_180538_4_, double p_180538_6_, float p_180538_8_, int p_180538_9_)
	{
		int j;
		...
		else
		{
			...
			if (block instanceof BlockPlutoAncientChest && j == 0)
			{
				((BlockPlutoAncientChest)block).checkForSurroundingChests(chest.getWorld(), chest.getPos(), chest.getWorld().getBlockState(chest.getPos()));
				j = chest.getBlockMetadata();
			}
	...
	{
		this.func_180538_a((TileEntityPlutoAncientChest)p_180535_1_, posX, posZ, p_180535_6_, p_180535_8_, p_180535_9_);
	}
}