...
public class CraftingRecipesPluto
{
	...
	{
		FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PlutoBlocks.pluto_block, 1, 3), new ItemStack(PlutoBlocks.pluto_block, 1, 2), 0.4F);
	}

	private static void addItemSmelting()
	{
		//FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PlutoBlocks.pluto_block, 1, 4), new ItemStack(GCItems.meteoricIronIngot), 0.8F);
		FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PlutoBlocks.pluto_block, 1, 5), new ItemStack(KapteynBItems.kapteyn_b_item, 1, 0), 0.8F);
		FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PlutoBlocks.pluto_block, 1, 6), new ItemStack(Items.iron_ingot), 0.8F);
		FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PlutoBlocks.pluto_block, 1, 7), new ItemStack(PlutoItems.pluto_item, 1, 0), 0.8F);
		FurnaceRecipes.instance().addSmeltingRecipe(new ItemStack(PlutoItems.space_potato, 1, 0), new ItemStack(PlutoItems.space_potato, 1, 1), 0.5F);
	}
}