...
public class MPInfoRegion extends Gui
{
	protected int width;
	...
	public MPInfoRegion(int par2, int par3, int par4, int par5, List<String> tooltipStrings, int parentWidth, int parentHeight)
	{
		this.width = 200;
		this.height = 20;
		this.enabled = true;
	...
	public void drawRegion(int par2, int par3)
	{
		...
		if (this.tooltipStrings != null && !this.tooltipStrings.isEmpty() && this.withinRegion)
		{
			...
			this.zLevel = 300.0F;
			MPInfoRegion.itemRenderer.zLevel = 300.0F;
			int l1 = -267386864;
			...
			this.zLevel = 0.0F;
			MPInfoRegion.itemRenderer.zLevel = 0.0F;
