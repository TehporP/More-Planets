...
public class DionaBlockAncientChest extends BlockContainer
{
	private final Random random = new Random();

	public DionaBlockAncientChest(int par1)
	{
	...
	public void onNeighborBlockChange(World par1World, int par2, int par3, int par4, int par5)
	{
		...
		DionaTileEntityAncientChest tileentitychest = (DionaTileEntityAncientChest)par1World.getBlockTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		else if (par1World.rand.nextInt(10) == 0)
		{
			...
			{
				DionaEntityMinionCreeper creeper = new DionaEntityMinionCreeper(par1World);
	...
	public IInventory getInventory(World par1World, int par2, int par3, int par4)
	{
		...
		else
		{
			if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID)
			{
				object = new InventoryLargeChest("container.chestDouble", (DionaTileEntityAncientChest)par1World.getBlockTileEntity(par2 - 1, par3, par4), (IInventory)object);
			}

			if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID)
			{
				object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (DionaTileEntityAncientChest)par1World.getBlockTileEntity(par2 + 1, par3, par4));
			}

			if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID)
			{
				object = new InventoryLargeChest("container.chestDouble", (DionaTileEntityAncientChest)par1World.getBlockTileEntity(par2, par3, par4 - 1), (IInventory)object);
			}

			if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID)
			{
				object = new InventoryLargeChest("container.chestDouble", (IInventory)object, (DionaTileEntityAncientChest)par1World.getBlockTileEntity(par2, par3, par4 + 1));
			}
	...
	{
		DionaTileEntityAncientChest tileentitychest = new DionaTileEntityAncientChest();
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("diona:dionaAncientChest");
	}
}