...
public class DionaBlockTitaniumFence extends BlockFence
{
	public final String field_94464_a;

	public DionaBlockTitaniumFence(int par1, String par2Str, Material par3Material)
	{
		super(par1, par2Str, Material.rock);
		this.field_94464_a = "titaniumFence";
