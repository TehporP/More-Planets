...
package stevekung.mods.moreplanets.diona.core.models.entities;
...
public class DionaModelCreeperBoss extends ModelBase
{
	...
	public DionaModelCreeperBoss()
	{
		this(0.0F);
	}

	public DionaModelCreeperBoss(float par1)
	{
	...
	public void render(Entity par1Entity, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		...
		final DionaEntityCreeperBoss creeper = (DionaEntityCreeperBoss) par1Entity;
