...
public class DionaSkyProvider extends IRenderHandler
{
	...
	private static final ResourceLocation koentusTexture = new ResourceLocation("koentus:textures/gui/planets/koentus.png");
	private static final ResourceLocation pinwheelTexture = new ResourceLocation("diona:textures/gui/planets/galaxy/pinwheel.png");
	...
	{
		DionaWorldProvider gcProvider = null;

		if (world.provider instanceof DionaWorldProvider)
		{
			gcProvider = (DionaWorldProvider) world.provider;
		}
		...
		GL11.glRotatef(0.0F, 5.0F, 0.0F, 20.0F);
		GL11.glRotatef(-120F, -500.0F, -5.0F, 25.0F);
		...
		GL11.glRotatef(-35F, -60.0F, -5.0F, 12.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		...
		GL11.glRotatef(90F, 6.0F, 0.0F, 0.0F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(pinwheelTexture);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, -100.0D, var12, 0, 1);
		var23.addVertexWithUV(var12, -100.0D, var12, 1, 1);
		...
		GL11.glRotatef(-600F, 20.0F, 10.0F, 0.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		GL11.glRotatef(world.getCelestialAngle(partialTicks) * 360.0F, 10.0F, 0.0F, 0.0F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(koentusTexture);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, -100.0D, var12, 0, 1);
		var23.addVertexWithUV(var12, -100.0D, var12, 1, 1);
		var23.addVertexWithUV(var12, -100.0D, -var12, 1, 0);
