...
package stevekung.mods.moreplanets.diona.core.render.blocks;
...
public class DionaBlockRendererKoentusMeteor implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public DionaBlockRendererKoentusMeteor(int var1)
	{
		this.renderID = var1;
	}
	...
	public static void renderInvNormalBlock(RenderBlocks var0, Block var1, int var2)
	{
		...
		DionaBlockRendererKoentusMeteor.renderStandardBlock(var0, var1, var2);
	...
	{
		DionaBlockRendererKoentusMeteor.renderInvNormalBlock(renderer, block, metadata);
	}
