...
package stevekung.mods.moreplanets.diona.core.render.gui;

import micdoodle8.mods.galacticraft.api.world.ICelestialBodyRenderer;
import net.minecraft.client.renderer.Tessellator;
import net.minecraft.util.ResourceLocation;

public class DionaSlotGuiRenderer implements ICelestialBodyRenderer
{
	@Override
	...
	{
		return new ResourceLocation("diona:textures/gui/planets/diona.png");
	}
