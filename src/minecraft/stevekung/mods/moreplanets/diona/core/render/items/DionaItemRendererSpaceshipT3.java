...
public class DionaItemRendererSpaceshipT3 extends GCCoreItemRendererSpaceship
{
	private static final ResourceLocation rocketNoFlagTexture = new ResourceLocation("diona:textures/model/rocketT3.png");
	private ModelBase rocketNoFlagModel;

	public DionaItemRendererSpaceshipT3(ModelBase rocketNoFlagModel)
	{
		super(new DionaEntityRocketT3(FMLClientHandler.instance().getClient().theWorld), new MPModelSpaceship(), new ResourceLocation("diona:textures/model/rocketT3.png"));
	...
	protected void renderSpaceship(ItemRenderType type, RenderBlocks render, ItemStack item, float translateX, float translateY, float translateZ)
	{
		...
		{
			FMLClientHandler.instance().getClient().renderEngine.bindTexture(rocketNoFlagTexture);
	...
	public void transform(ItemStack itemstack, ItemRenderType type)
	{
		...
		if (type == ItemRenderType.EQUIPPED)
		{
			...
			if (player != null && player.ridingEntity != null && player.ridingEntity instanceof DionaEntityRocketT3)
			{
