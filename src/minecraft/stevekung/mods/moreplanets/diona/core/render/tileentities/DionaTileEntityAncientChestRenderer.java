...
package stevekung.mods.moreplanets.diona.core.render.tileentities;
...
public class DionaTileEntityAncientChestRenderer extends TileEntitySpecialRenderer
{
	...
	private static final ResourceLocation chestNormal = new ResourceLocation("diona:textures/model/dionaAncientChest.png");
	private static final ResourceLocation largeChestNormal = new ResourceLocation("diona:textures/model/dionaAncientChestLarge.png");;
	...
	public DionaTileEntityAncientChestRenderer()
	{
	...
	public void renderTileEntityChestAt(DionaTileEntityAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
	{
		int i;
		...
		else
		{
			...
			if (block instanceof DionaBlockAncientChest && i == 0)
			{
				try
				{
					((DionaBlockAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
				}
	...
	{
		this.renderTileEntityChestAt((DionaTileEntityAncientChest)par1TileEntity, par2, par4, par6, par8);
	}
}