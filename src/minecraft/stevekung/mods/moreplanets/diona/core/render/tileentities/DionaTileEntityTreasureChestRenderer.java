...
public class DionaTileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation("diona:textures/model/dionaTreasureChest.png");

	private final GCCoreModelTreasureChest chestModel = new GCCoreModelTreasureChest();

	public void renderTileEntityTreasureChestAt(DionaTileEntityTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9 = 0;
	...
	{
		this.renderTileEntityTreasureChestAt((DionaTileEntityTreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}