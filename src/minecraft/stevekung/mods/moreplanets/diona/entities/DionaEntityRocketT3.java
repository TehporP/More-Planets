...
public class DionaEntityRocketT3 extends EntityTieredRocket
{
	public IUpdatePlayerListBox rocketSoundUpdater;

	public DionaEntityRocketT3(World par1World)
	{
		super(par1World);
	}

	public DionaEntityRocketT3(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
	{
	...
	public DionaEntityRocketT3(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		droppedItems.add(new ItemStack(DionaItems.rocketT3, 1, this.rocketType.getIndex()));
		return droppedItems;
	}
}