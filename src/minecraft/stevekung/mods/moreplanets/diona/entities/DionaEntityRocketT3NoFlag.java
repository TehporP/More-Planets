...
public class DionaEntityRocketT3NoFlag extends EntityTieredRocket
{
	public IUpdatePlayerListBox rocketSoundUpdater;

	public DionaEntityRocketT3NoFlag(World par1World)
	{
		super(par1World);
	}

	public DionaEntityRocketT3NoFlag(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
	{
	...
	public DionaEntityRocketT3NoFlag(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public void onTeleport(EntityPlayerMP player)
	{
		...
		if (playerBase != null)
		{
			...
			playerBase.setRocketItem(DionaItems.rocketT3);
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		droppedItems.add(new ItemStack(DionaItems.rocketT3, 1, this.rocketType.getIndex() + 10));
		return droppedItems;
	}
}