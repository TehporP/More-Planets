...
public class DionaEntityThailandFlag extends Entity
{
	...
	public DionaEntityThailandFlag(World world)
	{
		super(world);
		this.yOffset = 1.5F;
	...
	public DionaEntityThailandFlag(World par1World, double x, double y, double z, float dir)
	{
		this(par1World);
	...
	{
		this.entityDropItem(new ItemStack(DionaItems.thailandFlag, 1, this.getType()), 0.0F);
	}
