...
public class DionaEntityProjectileFronisiumTNT extends EntityFireball
{
	public DionaEntityProjectileFronisiumTNT(World par1World)
	{
		super(par1World);
		this.setSize(1.0F, 1.0F);
	}

	public DionaEntityProjectileFronisiumTNT(World par1World, EntityLivingBase par2EntityLivingBase, double par3, double par5, double par7)
	{
	...
	public DionaEntityProjectileFronisiumTNT(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
	{
	...
	protected void onImpact(MovingObjectPosition movingObjectPosition)
	{
		if (!this.worldObj.isRemote)
		{
			...
			if (!this.worldObj.isRemote && this.rand.nextInt(8) == 0)
			{
				...
				for (int i = 0; i < b0; ++i)
				{
					DionaEntityMinionCreeper creeper = new DionaEntityMinionCreeper(this.worldObj);
