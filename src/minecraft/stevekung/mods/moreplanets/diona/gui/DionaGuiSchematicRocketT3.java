...
public class DionaGuiSchematicRocketT3 extends GuiContainer implements ISchematicResultPage
{
	...
	public DionaGuiSchematicRocketT3(InventoryPlayer par1InventoryPlayer, int x, int y, int z)
	{
		super(new DionaContainerRocketBenchT3(par1InventoryPlayer, x, y, z));
		this.ySize = 238;
	}
	...
	protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3)
	{
		...
		this.mc.renderEngine.bindTexture(DionaGuiSchematicRocketT3.tier3SchematicTexture);
