...
public class DionaSlotRocketBenchT3 extends Slot
{
	private final int index;
	private final int x, y, z;
	private final EntityPlayer player;

	public DionaSlotRocketBenchT3(IInventory par2IInventory, int par3, int par4, int par5, int x, int y, int z, EntityPlayer player)
	{
	...
	public boolean isItemValid(ItemStack par1ItemStack)
	{
		...
		case 2:
			return par1ItemStack.getItem().itemID == DionaItems.dionaBasicItem.itemID && par1ItemStack.getItemDamage() == 6 ? true : false;
		case 3:
			return par1ItemStack.getItem().itemID == DionaItems.dionaBasicItem.itemID && par1ItemStack.getItemDamage() == 6 ? true : false;
		case 4:
			return par1ItemStack.getItem().itemID == DionaItems.dionaBasicItem.itemID && par1ItemStack.getItemDamage() == 6 ? true : false;
		...
		case 11:
			return par1ItemStack.getItem().itemID == DionaItems.dionaBasicItem.itemID && par1ItemStack.getItemDamage() == 6 ? true : false;
		case 12:
			return par1ItemStack.getItem().itemID == DionaItems.rocketPartT3.itemID && par1ItemStack.getItemDamage() == 3 ? true : false;
		case 13:
			return par1ItemStack.getItem().itemID == DionaItems.rocketPartT3.itemID && par1ItemStack.getItemDamage() == 1 ? true : false;
		case 14:
			return par1ItemStack.getItem().itemID == DionaItems.rocketPartT3.itemID && par1ItemStack.getItemDamage() == 1 ? true : false;
		case 15:
			return par1ItemStack.getItem().itemID == DionaItems.rocketPartT3.itemID && par1ItemStack.getItemDamage() == 2 ? true : false;
		case 16:
			return par1ItemStack.getItem().itemID == DionaItems.rocketPartT3.itemID && par1ItemStack.getItemDamage() == 3 ? true : false;
		case 17:
			return par1ItemStack.getItem().itemID == DionaItems.rocketPartT3.itemID && par1ItemStack.getItemDamage() == 1 ? true : false;
