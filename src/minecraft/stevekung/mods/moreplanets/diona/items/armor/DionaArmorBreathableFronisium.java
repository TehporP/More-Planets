...
public class DionaArmorBreathableFronisium extends ItemArmor implements IBreathableArmor
{
	public DionaArmorBreathableFronisium(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
	...
	{
		if (stack.itemID == DionaArmorItems.breathableFronisiumHelmet.itemID)
		{
			return "diona:textures/model/armor/breathableFronisium_1.png";
		}
		return null;
	}
	...
	{
		if (par1ItemStack.itemID == DionaArmorItems.breathableFronisiumHelmet.itemID)
		{
			return true;
		}
		return false;
