...
import stevekung.mods.moreplanets.diona.blocks.DionaBlockT3TreasureChest;
import cpw.mods.fml.common.FMLCommonHandler;
import cpw.mods.fml.common.network.PacketDispatcher;
import cpw.mods.fml.relauncher.Side;

public class DionaTileEntityTreasureChest extends GCCoreTileEntityAdvanced implements IInventory, IKeyable
{
	...
	public DionaTileEntityTreasureChest()
	{
		this(3);
	}

	public DionaTileEntityTreasureChest(int tier)
	{
		this.tier = tier;
	}
	...
	{
		if (this.getBlockType() != null && this.getBlockType() instanceof DionaBlockT3TreasureChest)
		{
			--this.numUsingPlayers;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
	...
	{
		return FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT ? StatCollector.translateToLocal("container.diona.treasurechest.name") : StatCollector.translateToLocal("container.diona.treasurechest.name");
	}
