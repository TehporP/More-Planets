								...
								for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
								{
									...
									if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
									{
										if (var51 > -0.7D)
										{
											...
											if (arrayOfIDs[coords] == DionaBlocks.dionaBasicBlock.blockID || arrayOfIDs[coords] == DionaBlocks.minionCreeperEgg.blockID)
											{
												arrayOfIDs[coords] = 0;
											}
										}
								...
								for (int var50 = caveMaxY - 1; var50 >= caveMinY; --var50)
								{
									...
									if (var59 * var59 + var51 * var51 + var46 * var46 < 1.0D)
									{
										if (var51 > -0.7D)
										{
											...
											{
												if (arrayOfIDs[coordsAbove] == DionaBlocks.dionaBasicBlock.blockID && this.rand.nextInt(200) == 0)
												{
												}
												else if (arrayOfIDs[coordsBelow] == DionaBlocks.dionaBasicBlock.blockID && this.rand.nextInt(200) == 0)
												{
													arrayOfIDs[coords] = (short) DionaBlocks.minionCreeperEgg.blockID;
