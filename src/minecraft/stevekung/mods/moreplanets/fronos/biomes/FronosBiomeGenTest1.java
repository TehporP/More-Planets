...
public class FronosBiomeGenTest1 extends BiomeGenBase
{
	public FronosBiomeGenTest1(int par1)
	{
		super(par1);
		this.spawnableCreatureList.clear();
		this.theBiomeDecorator = new FronosBiomeDecorator(this);
		this.topBlock = (byte)FronosBlocks.fronosPinkGrass.blockID;
		this.fillerBlock = (byte)FronosBlocks.fronosDirt.blockID;
	...
	{
		return par1Random.nextInt(9) == 0 ? new FronosWorldGenPineTree() : new WorldGenCanyonShrub(0,0);
	}*/
