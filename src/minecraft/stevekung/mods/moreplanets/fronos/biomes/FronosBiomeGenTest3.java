...
public class FronosBiomeGenTest3 extends BiomeGenBase
{
	private FronosBiomeDecorator customBiomeDecorator;

	public FronosBiomeGenTest3(int par1)
	{
		super(par1);
		...
		this.customBiomeDecorator = (FronosBiomeDecorator)this.theBiomeDecorator;
	...
	{
		return new FronosWorldGenCoconutTree1();
	}
}