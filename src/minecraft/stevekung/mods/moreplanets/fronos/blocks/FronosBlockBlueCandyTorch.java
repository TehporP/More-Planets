...
public class FronosBlockBlueCandyTorch extends BlockTorch
{
	public FronosBlockBlueCandyTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:blueCandyTorch");
	}
