...
public class FronosBlockCake extends Block
{
	public Icon[] cakeBlockIcons;

	public FronosBlockCake(int par1, Material material)
	{
	...
	{
		this.cakeBlockIcons = new Icon[4];
		this.cakeBlockIcons[0] = par1IconRegister.registerIcon("fronos:cakeBottom");
		this.cakeBlockIcons[1] = par1IconRegister.registerIcon("fronos:cakeBottom");
		this.cakeBlockIcons[2] = par1IconRegister.registerIcon("fronos:cakeDeBlockSide");
		this.cakeBlockIcons[3] = par1IconRegister.registerIcon("fronos:cakeDeBlockSide");
	}
	...
	{
		return FronosItems.cakeBlock.itemID;
	}
}