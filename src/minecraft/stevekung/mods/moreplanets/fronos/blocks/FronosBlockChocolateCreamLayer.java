...
public class FronosBlockChocolateCreamLayer extends Block
{
	public FronosBlockChocolateCreamLayer(int par1)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:chocolateCream");
	}
