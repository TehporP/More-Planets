...
public class FronosBlockColorizedLeaves extends BlockLeavesBase implements IShearable
{
	...
	private static final String[] leaves = new String[] {"coconut"};
	private Icon[][] textures;
	private final LeafCategory category;
	int[] adjacentTreeBlocks;

	public FronosBlockColorizedLeaves(int blockID, LeafCategory cat)
	{
	...
	public void updateTick(World world, int x, int y, int z, Random random)
	{
		...
		if (meta == 0)
		{
			if (world.rand.nextInt(2000) == 0)
			{
				if (true)
				{
					world.setBlock(x, y - 1, z, FronosBlocks.coconutBlock.blockID, 0, 3);
				}
			}
		}
	}
	...
	{
		return getTypeFromMeta(meta) + this.category.ordinal() * 4;
	}
