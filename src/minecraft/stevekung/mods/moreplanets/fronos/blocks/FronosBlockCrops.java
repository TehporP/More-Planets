...
public class FronosBlockCrops extends BlockCrops
{
	@SideOnly(Side.CLIENT)
	private Icon[] iconArray;

	public FronosBlockCrops(int par1)
	{
		super(par1);
	...
	{
		return FronosItems.goldenSeed.itemID;
	}
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		...
		{
			this.iconArray[i] = par1IconRegister.registerIcon("fronos:goldenWheatStage_" + i);
		}
	}
}