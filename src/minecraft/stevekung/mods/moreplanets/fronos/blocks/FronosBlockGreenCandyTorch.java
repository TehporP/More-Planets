...
public class FronosBlockGreenCandyTorch extends BlockTorch
{
	public FronosBlockGreenCandyTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:greenCandyTorch");
	}
