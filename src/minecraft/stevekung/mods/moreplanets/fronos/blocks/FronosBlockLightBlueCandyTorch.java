...
public class FronosBlockLightBlueCandyTorch extends BlockTorch
{
	public FronosBlockLightBlueCandyTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:lightBlueCandyTorch");
	}
