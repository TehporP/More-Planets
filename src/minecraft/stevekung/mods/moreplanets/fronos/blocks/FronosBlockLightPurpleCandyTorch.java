...
public class FronosBlockLightPurpleCandyTorch extends BlockTorch
{
	public FronosBlockLightPurpleCandyTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:lightPurpleCandyTorch");
	}
