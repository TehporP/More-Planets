...
public class FronosBlockLog extends Block
{
	...
	private static final String[] types = new String[] {"coconut", "redMaple"/*, "dark", "fir", "holy", "magic", "mangrove", "palm", "redwood", "willow", "dead", "bigflowerstem", "pine", "hellbark", "jacaranda"*/};
	private Icon[] textures;
	private Icon[] logHearts;

	private final LogCategory category;

	public FronosBlockLog(int blockID, LogCategory cat)
	{
	...
	public void registerIcons(IconRegister iconRegister)
	{
		...
		{
			this.textures[i] = iconRegister.registerIcon("fronos:log_" + types[i] + "_side");
			this.logHearts[i] = iconRegister.registerIcon("fronos:log_" + types[i] + "_heart");
		}
	}
