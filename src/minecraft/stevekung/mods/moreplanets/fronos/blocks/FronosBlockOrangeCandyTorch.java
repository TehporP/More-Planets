...
public class FronosBlockOrangeCandyTorch extends BlockTorch
{
	public FronosBlockOrangeCandyTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:orangeCandyTorch");
	}
