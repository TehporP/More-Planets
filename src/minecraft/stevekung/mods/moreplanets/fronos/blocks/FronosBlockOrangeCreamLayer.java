...
public class FronosBlockOrangeCreamLayer extends Block
{
	public FronosBlockOrangeCreamLayer(int par1)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:orangeCream");
	}
