...
public class FronosBlockPinkCake extends Block
{
	public Icon[] pinkCakeIcons;

	public FronosBlockPinkCake(int par1, Material material)
	{
	...
	{
		this.pinkCakeIcons = new Icon[4];
		this.pinkCakeIcons[0] = par1IconRegister.registerIcon("fronos:cakePinkTop");
		this.pinkCakeIcons[1] = par1IconRegister.registerIcon("fronos:cakeBottom");
		this.pinkCakeIcons[2] = par1IconRegister.registerIcon("fronos:cakePinkInner");
		this.pinkCakeIcons[3] = par1IconRegister.registerIcon("fronos:cakePinkSide");
	}
	...
	private void eatCakeSlice(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer)
	{
		...
		{
			par5EntityPlayer.getFoodStats().addStats(2, 0.4F);
	...
	{
		return FronosItems.pinkCakeBlock.itemID;
	}
}