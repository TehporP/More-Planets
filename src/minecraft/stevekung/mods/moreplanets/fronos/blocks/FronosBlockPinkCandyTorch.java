...
public class FronosBlockPinkCandyTorch extends BlockTorch
{
	public FronosBlockPinkCandyTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:pinkCandyTorch");
	}
