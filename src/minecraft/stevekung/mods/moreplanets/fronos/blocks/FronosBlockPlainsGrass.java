...
public class FronosBlockPlainsGrass extends Block implements ITerraformableBlock
{
	private Icon[] fronosGrassIcon;

	public FronosBlockPlainsGrass(int id)
	{
	...
	public void registerIcons(IconRegister par1IconRegister)
	{
		...
		this.fronosGrassIcon[1] = par1IconRegister.registerIcon("fronos:fronosPlainsGrassTop");
		this.fronosGrassIcon[2] = par1IconRegister.registerIcon("fronos:fronosPlainsGrassSide");
		this.fronosGrassIcon[3] = par1IconRegister.registerIcon("fronos:fronosPlainsGrassSide");
		this.fronosGrassIcon[4] = par1IconRegister.registerIcon("fronos:fronosPlainsGrassSide");
		this.fronosGrassIcon[5] = par1IconRegister.registerIcon("fronos:fronosPlainsGrassSide");
		this.fronosGrassIcon[6] = par1IconRegister.registerIcon("fronos:fronosGrassSideOrange");
	}
	...
	public Icon getBlockTexture(IBlockAccess par1IBlockAccess, int par2, int par3, int par4, int par5)
	{
		...
		{
			return block != FronosBlocks.orangeCreamLayer.blockID && block != FronosBlocks.orangeCream.blockID ? this.fronosGrassIcon[2] : this.fronosGrassIcon[6];
		}
		...
		if (!par1World.isRemote)
		{
			...
			else if (par1World.getBlockLightValue(par2, par3 + 1, par4) >= 9)
			{
				for (int var6 = 0; var6 < 4; ++var6)
				{
					...
					{
						par1World.setBlock(var7, var8, var9, FronosBlocks.fronosPlainsGrass.blockID);
					}
				}
			}
		}
