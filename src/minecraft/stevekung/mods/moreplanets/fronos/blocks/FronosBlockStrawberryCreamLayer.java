...
public class FronosBlockStrawberryCreamLayer extends Block
{
	public FronosBlockStrawberryCreamLayer(int par1)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:strawberryCream");
	}
