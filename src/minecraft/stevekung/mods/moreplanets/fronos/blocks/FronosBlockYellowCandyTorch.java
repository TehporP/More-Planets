...
public class FronosBlockYellowCandyTorch extends BlockTorch
{
	public FronosBlockYellowCandyTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("fronos:yellowCandyTorch");
	}
