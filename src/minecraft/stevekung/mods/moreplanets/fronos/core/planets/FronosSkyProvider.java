...
public class FronosSkyProvider extends IRenderHandler
{
	...
	{
		FronosWorldProvider gcProvider = null;

		if (world.provider instanceof FronosWorldProvider)
		{
			gcProvider = (FronosWorldProvider) world.provider;
		}
		...
		GL11.glRotatef(90.0F, 70.0F, -40.0F, 40.0F);
		GL11.glRotatef(200F, -300.0F, 10.0F, 10.0F);
		...
		var12 = 3.1F;
		GL11.glScalef(0.6F, 0.6F, 0.6F);
		GL11.glRotatef(-35.0F, 40.0F, -20.0F, 40.0F);
		GL11.glRotatef(-50F, -100.0F, 10.0F, 150.0F);
