...
public class FronosBlockRendererSpaceOyster implements ISimpleBlockRenderingHandler
{
	final int renderID;
	private final FronosTileEntitySpaceOyster oyster = new FronosTileEntitySpaceOyster();

	public FronosBlockRendererSpaceOyster(int var1)
	{
		this.renderID = var1;
	}
