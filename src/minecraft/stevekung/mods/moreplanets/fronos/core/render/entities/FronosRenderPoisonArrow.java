...
public class FronosRenderPoisonArrow extends Render
{
	private static final ResourceLocation arrowTextures = new ResourceLocation("fronos:textures/model/poisonArrow.png");

	public void renderArrow(FronosEntityPoisonArrow par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
	{
	...
	protected ResourceLocation getArrowTextures(FronosEntityPoisonArrow par1EntityArrow)
	{
	...
	{
		return this.getArrowTextures((FronosEntityPoisonArrow)par1Entity);
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
	{
		this.renderArrow((FronosEntityPoisonArrow)par1Entity, par2, par4, par6, par8, par9);
	}
}