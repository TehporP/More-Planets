...
public class FronosTileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation("fronos:textures/model/fronosTreasureChest.png");

	private final GCCoreModelTreasureChest chestModel = new GCCoreModelTreasureChest();

	public void renderTileEntityTreasureChestAt(FronosTileEntityTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		this.bindTexture(FronosTileEntityTreasureChestRenderer.treasureChestTexture);
	...
	{
		this.renderTileEntityTreasureChestAt((FronosTileEntityTreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}