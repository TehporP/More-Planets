...
public class FronosEntityJellyBerrySlime extends EntityLiving implements IMob, IEntityBreathable
{
	...
	public FronosEntityJellyBerrySlime(World par1World)
	{
		super(par1World);
	...
	public void onUpdate()
	{
		...
		if (this.onGround && !flag)
		{
			...
			for (int j = 0; j < i * 8; ++j)
			{
				...
				MorePlanetCore.proxy.spawnParticle("jellyBerry", this.posX + f2, this.boundingBox.minY, this.posZ + f3);
			}
	...
	protected FronosEntityJellyBerrySlime createInstance()
	{
		return new FronosEntityJellyBerrySlime(this.worldObj);
	}
	...
	public void setDead()
	{
		...
		if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
		{
			...
			for (int k = 0; k < j; ++k)
			{
				...
				FronosEntityJellyBerrySlime entityslime = this.createInstance();
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		if (this.getSlimeSize() == 1)
		{
			...
			for (int k = 0; k < j; ++k)
			{
				this.entityDropItem(new ItemStack(FronosItems.jelly, 1, 3), 0.0F);
			}
		}
	}
