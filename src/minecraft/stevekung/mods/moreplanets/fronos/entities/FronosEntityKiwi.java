...
public class FronosEntityKiwi extends EntityAnimal implements IEntityBreathable, IImmuneMapleIvy
{
	public FronosEntityKiwi(World par1World)
	{
		super(par1World);
	...
	public FronosEntityKiwi spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		return new FronosEntityKiwi(this.worldObj);
	}
