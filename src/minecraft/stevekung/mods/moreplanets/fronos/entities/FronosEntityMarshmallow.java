...
public class FronosEntityMarshmallow extends EntityAnimal implements IEntityBreathable, IImmuneMapleIvy
{
	public FronosEntityMarshmallow(World par1World)
	{
		super(par1World);
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		for (int k = 0; k < j; ++k)
		{
			this.entityDropItem(new ItemStack(FronosItems.fronosFood, 1, 2), 0.0F);
		}
		if (this.isBurning())
		{
			this.entityDropItem(new ItemStack(FronosItems.fronosFood, 1, 3), 0.0F);
		}
		else
		{
			this.entityDropItem(new ItemStack(FronosItems.fronosFood, 1, 2), 0.0F);
	...
	public FronosEntityMarshmallow spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		return new FronosEntityMarshmallow(this.worldObj);
	}
