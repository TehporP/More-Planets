...
public class FronosEntityOrangeCreamSlime extends EntityLiving implements IMob, IEntityBreathable
{
	...
	public FronosEntityOrangeCreamSlime(World par1World)
	{
		super(par1World);
	...
	public void onUpdate()
	{
		...
		if (this.onGround && !flag)
		{
			...
			for (int j = 0; j < i * 8; ++j)
			{
				...
				MorePlanetCore.proxy.spawnParticle("orangeBall", this.posX + f2, this.boundingBox.minY, this.posZ + f3);
			}
	...
	protected FronosEntityOrangeCreamSlime createInstance()
	{
		return new FronosEntityOrangeCreamSlime(this.worldObj);
	}
	...
	public void setDead()
	{
		...
		if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
		{
			...
			for (int k = 0; k < j; ++k)
			{
				...
				FronosEntityOrangeCreamSlime entityslime = this.createInstance();
