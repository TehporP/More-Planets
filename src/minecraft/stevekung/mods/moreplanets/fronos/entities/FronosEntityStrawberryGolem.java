...
public class FronosEntityStrawberryGolem extends EntityGolem implements IRangedAttackMob, IEntityBreathable
{
	public FronosEntityStrawberryGolem(World par1World)
	{
		super(par1World);
	...
	public void onLivingUpdate()
	{
		...
		for (i = 0; i < 4; ++i)
		{
			...
			if (this.worldObj.getBlockId(j, k, l) == 0 && FronosBlocks.strawberryCreamLayer.canPlaceBlockAt(this.worldObj, j, k, l))
			{
				this.worldObj.setBlock(j, k, l, FronosBlocks.strawberryCreamLayer.blockID);
			}
		}
	}
	...
	{
		FronosEntityStrawberryCreamBall entitysnowball = new FronosEntityStrawberryCreamBall(this.worldObj, this);
