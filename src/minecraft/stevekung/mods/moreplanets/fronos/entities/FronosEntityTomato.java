...
public class FronosEntityTomato extends EntityAnimal implements IEntityBreathable
{
	public int timeUntilToDropTomato;

	public FronosEntityTomato(World par1World)
	{
		super(par1World);
		this.setSize(0.65F, 1.0F);
	...
	protected void applyEntityAttributes()
	{
		...
		this.getEntityAttribute(SharedMonsterAttributes.movementSpeed).setAttribute(0.05D);
	}
	...
	public FronosEntityTomato spawnBabyAnimal(EntityAgeable par1EntityAgeable)
	{
		return new FronosEntityTomato(this.worldObj);
	}
