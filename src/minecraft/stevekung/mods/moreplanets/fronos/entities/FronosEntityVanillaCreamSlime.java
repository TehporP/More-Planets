...
public class FronosEntityVanillaCreamSlime extends EntityLiving implements IMob, IEntityBreathable
{
	...
	public FronosEntityVanillaCreamSlime(World par1World)
	{
		super(par1World);
	...
	public void onUpdate()
	{
		...
		if (this.onGround && !flag)
		{
			...
			for (int j = 0; j < i * 8; ++j)
			{
				...
				MorePlanetCore.proxy.spawnParticle("vanillaBall", this.posX + f2, this.boundingBox.minY, this.posZ + f3);
			}
	...
	protected FronosEntityVanillaCreamSlime createInstance()
	{
		return new FronosEntityVanillaCreamSlime(this.worldObj);
	}
	...
	public void setDead()
	{
		...
		if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
		{
			...
			for (int k = 0; k < j; ++k)
			{
				...
				FronosEntityVanillaCreamSlime entityslime = this.createInstance();
