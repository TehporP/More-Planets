...
public class FronosEntityVanillaGolem extends EntityGolem implements IRangedAttackMob, IEntityBreathable
{
	public FronosEntityVanillaGolem(World par1World)
	{
		super(par1World);
	...
	public void onLivingUpdate()
	{
		...
		for (i = 0; i < 4; ++i)
		{
			...
			if (this.worldObj.getBlockId(j, k, l) == 0 && FronosBlocks.vanillaCreamLayer.canPlaceBlockAt(this.worldObj, j, k, l))
			{
				this.worldObj.setBlock(j, k, l, FronosBlocks.vanillaCreamLayer.blockID);
			}
		}
	}
	...
	protected void dropFewItems(boolean par1, int par2)
	{
		...
		for (int k = 4; k < j; ++k)
		{
			this.entityDropItem(new ItemStack(FronosItems.creamBall, 1, 0), 0.0F);
		}
	}
	...
	{
		FronosEntityVanillaCreamBall entitysnowball = new FronosEntityVanillaCreamBall(this.worldObj, this);
