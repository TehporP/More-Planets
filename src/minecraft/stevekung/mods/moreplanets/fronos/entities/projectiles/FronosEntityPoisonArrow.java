...
public class FronosEntityPoisonArrow extends Entity implements IProjectile
{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public FronosEntityPoisonArrow(World par1World)
	{
		super(par1World);
	...
	public FronosEntityPoisonArrow(World par1World, double par2, double par4, double par6)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public FronosEntityPoisonArrow(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	...
	public FronosEntityPoisonArrow(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLivingBase;
	...
	public void onUpdate()
	{
		...
		else
		{
			...
			if (movingobjectposition != null)
			{
				...
				{
					((EntityLivingBase)movingobjectposition.entityHit).addPotionEffect(new PotionEffect(Potion.poison.id, 150));
					...
					{
						damagesource = MPDamageSource.causePoisonArrowDamage(this, this);
					}
					else
					{
						damagesource = MPDamageSource.causePoisonArrowDamage(this, this.shootingEntity);
					}
	...
	public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
	{
		if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
		{
			...
			if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(FronosItems.poisonArrow, 1)))
			{
				flag = false;
			}
