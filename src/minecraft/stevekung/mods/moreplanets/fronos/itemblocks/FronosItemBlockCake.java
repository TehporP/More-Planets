...
public class FronosItemBlockCake extends ItemReed
{
	public FronosItemBlockCake(int par1, Block par2Block)
	{
		super(par1, FronosBlocks.cakeBlock);
	...
	{
		this.itemIcon = iconRegister.registerIcon("fronos:cakeDefault");
	}
