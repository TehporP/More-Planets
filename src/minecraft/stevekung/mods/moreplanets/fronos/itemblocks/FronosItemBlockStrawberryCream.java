...
public class FronosItemBlockStrawberryCream extends ItemBlockWithMetadata
{
	public FronosItemBlockStrawberryCream(int par1, Block par2Block)
	{
		super(par1, FronosBlocks.strawberryCreamLayer);
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			if (i1 == FronosBlocks.strawberryCreamLayer.blockID)
			{
