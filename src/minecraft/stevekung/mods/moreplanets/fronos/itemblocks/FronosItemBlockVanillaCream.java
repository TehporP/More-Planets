...
public class FronosItemBlockVanillaCream extends ItemBlockWithMetadata
{
	public FronosItemBlockVanillaCream(int par1, Block par2Block)
	{
		super(par1, FronosBlocks.vanillaCreamLayer);
	}
	...
	public boolean onItemUse(ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, World par3World, int par4, int par5, int par6, int par7, float par8, float par9, float par10)
	{
		...
		else
		{
			...
			if (i1 == FronosBlocks.vanillaCreamLayer.blockID)
			{
