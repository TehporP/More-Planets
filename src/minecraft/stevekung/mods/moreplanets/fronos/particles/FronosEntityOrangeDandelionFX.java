...
public class FronosEntityOrangeDandelionFX extends EntityFX
{
	private static final String texture = "fronos:textures/particles/orangeDandelion.png";

	public FronosEntityOrangeDandelionFX(World par1World, double par2, double par4, double par6, float par8)
	{
	...
	public void renderParticle(Tessellator tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation("fronos:textures/particles/orangeDandelion.png"));
		tessellator.startDrawingQuads();
	}
