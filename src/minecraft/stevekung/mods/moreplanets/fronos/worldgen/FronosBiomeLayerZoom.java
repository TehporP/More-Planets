...
public class FronosBiomeLayerZoom extends FronosBiomeLayer
{
	public FronosBiomeLayerZoom(long par1, FronosBiomeLayer par3GenLayer)
	{
		super(par1);
	...
	public static FronosBiomeLayer func_75915_a(long par0, FronosBiomeLayer par2GenLayer, int par3)
	{
		Object object = par2GenLayer;

		for (int k = 0; k < par3; ++k)
		{
			object = new FronosBiomeLayerZoom(par0 + k, (FronosBiomeLayer)object);
		}
		return (FronosBiomeLayer)object;
	}
}