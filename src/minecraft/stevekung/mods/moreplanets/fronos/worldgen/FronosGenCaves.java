...
public class FronosGenCaves extends GCCoreMapGenBaseMeta
{
							...
							for (int localX = l1; localX < i2; localX++)
							{
								...
								for (int localZ = l2; localZ < i3; localZ++)
								{
									...
									if (xfactorSq + zfactorSq < 1.0D)
									{
										...
										{
											if (blockIdArray[coords] == FronosBlocks.fronosDirt.blockID && metaArray[coords] == 0 || blockIdArray[coords] == FronosBlocks.fronosStone.blockID && metaArray[coords] == 0)
											{
												blockIdArray[coords] = 0;
											}
											else if (blockIdArray[coords] == FronosBlocks.fronosGrass.blockID && metaArray[coords] == 0 && random.nextInt(FronosGenCaves.BREAK_THROUGH_CHANCE) == 0)
											{
												blockIdArray[coords] = 0;
											}
										}
