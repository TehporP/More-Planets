...
public class KapteynBBlockDirtyIce extends BlockBreakableMP
{
	public KapteynBBlockDirtyIce(int par1, Material par2Material)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("kapteynb:kapteynDirtyIce");
	}
}