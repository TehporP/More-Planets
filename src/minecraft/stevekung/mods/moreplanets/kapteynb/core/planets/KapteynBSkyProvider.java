...
public class KapteynBSkyProvider extends IRenderHandler
{
	private static final ResourceLocation m51Texture = new ResourceLocation("kapteynb:textures/gui/galaxy/m51.png");
	private static final ResourceLocation omegaCentauriTexture = new ResourceLocation("kapteynb:textures/gui/galaxy/omegaCentauri.png");
	private static final ResourceLocation kapteynStarTexture = new ResourceLocation("kapteynb:textures/gui/planets/kapteynStar.png");

	public int starGLCallList = GLAllocation.generateDisplayLists(3);
	public int glSkyList;
	public int glSkyList2;

	public KapteynBSkyProvider()
	{
		GL11.glPushMatrix();
	...
	{
		KapteynBWorldProvider gcProvider = null;

		if (world.provider instanceof KapteynBWorldProvider)
		{
			gcProvider = (KapteynBWorldProvider) world.provider;
		}
		...
		var12 = 20.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(kapteynStarTexture);
		...
		GL11.glRotatef(260F, 8.0F, 0.0F, 0.0F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(omegaCentauriTexture);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, -100.0D, var12, 0, 1);
		var23.addVertexWithUV(var12, -100.0D, var12, 1, 1);
