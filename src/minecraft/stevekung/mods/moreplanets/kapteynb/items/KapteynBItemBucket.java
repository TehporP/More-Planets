...
public class KapteynBItemBucket extends Item
{
	public int isFull;

	public static final String[] bucketTypes = new String[] {
		"frozenWaterBucket",
	};
	...
	public KapteynBItemBucket(int i)
	{
		super(i);
	...
	public boolean tryPlaceContainedLiquid(World par1World, double par2, double par4, double par6, int par8, int par9, int par10)
	{
		...
		{
			if (this.isFull == KapteynBBlocks.kapteynBFrozenWater.blockID)
			{
	...
	{
		return itemstack.getItemDamage() == 2 ? new ItemStack(Item.bucketEmpty, 1, 0) : new ItemStack(Item.bucketEmpty, 1, 0);
	}
	...
	private static int getLiquidIDFromMeta(int meta)
	{
		...
		{
		case 0:
			return KapteynBBlocks.kapteynBFrozenWater.blockID;
		default:
			return KapteynBBlocks.kapteynBFrozenWater.blockID;
		}
	}
	...
	{
		for (int i = 0; i < KapteynBItemBucket.bucketTypes.length; ++i)
		{
	...
	public String getUnlocalizedName(ItemStack itemStack)
	{
		...
		if (meta < 0 || meta >= KapteynBItemBucket.bucketTypes.length)
		{
			meta = 0;
		}
		return super.getUnlocalizedName() + "." + KapteynBItemBucket.bucketTypes[meta];
	}
	...
	public void registerIcons(IconRegister iconRegister)
	{
		...
		this.textures[0] = iconRegister.registerIcon("kapteynb:frozenWaterBucket");
	}
