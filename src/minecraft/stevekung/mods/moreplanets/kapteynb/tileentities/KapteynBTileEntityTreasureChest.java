...
package stevekung.mods.moreplanets.kapteynb.tileentities;
...
import stevekung.mods.moreplanets.kapteynb.blocks.KapteynBBlockT7TreasureChest;
import cpw.mods.fml.common.FMLCommonHandler;
import cpw.mods.fml.common.network.PacketDispatcher;
import cpw.mods.fml.relauncher.Side;

public class KapteynBTileEntityTreasureChest extends GCCoreTileEntityAdvanced implements IInventory, IKeyable
{
	...
	public int tier = 3;//TODO 7

	public KapteynBTileEntityTreasureChest()
	{
		this(3);
	}

	public KapteynBTileEntityTreasureChest(int tier)
	{
		this.tier = tier;
	}
	...
	{
		if (this.getBlockType() != null && this.getBlockType() instanceof KapteynBBlockT7TreasureChest)
		{
			--this.numUsingPlayers;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
	...
	{
		return FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT ? StatCollector.translateToLocal("container.kapteyn.treasurechest.name") : StatCollector.translateToLocal("container.kapteyn.treasurechest.name");
	}
