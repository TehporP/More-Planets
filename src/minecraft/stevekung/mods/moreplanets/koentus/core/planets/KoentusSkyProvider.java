...
public class KoentusSkyProvider extends IRenderHandler
{
	private static final ResourceLocation dionaTexture = new ResourceLocation("diona:textures/gui/planets/diona.png");
	private static final ResourceLocation polongniusTexture = new ResourceLocation("polongnius:textures/gui/planets/polongnius.png");
	private static final ResourceLocation fronosTexture = new ResourceLocation("fronos:textures/gui/planets/fronos.png");
	private static final ResourceLocation siriusTexture = new ResourceLocation("diona:textures/gui/planets/sun.png");
	private static final ResourceLocation m51Texture = new ResourceLocation("kapteynb:textures/gui/galaxy/m51.png");

	public int starGLCallList = GLAllocation.generateDisplayLists(3);
	public int glSkyList;
	public int glSkyList2;

	public KoentusSkyProvider()
	{
		GL11.glPushMatrix();
	...
	{
		KoentusWorldProvider gcProvider = null;

		if (world.provider instanceof KoentusWorldProvider)
		{
			gcProvider = (KoentusWorldProvider) world.provider;
		}
		...
		var12 = 30.0F;
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(siriusTexture);
		...
		GL11.glRotatef(300F, 12.0F, 3.0F, 0.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(dionaTexture);
		var23.startDrawingQuads();
		...
		GL11.glRotatef(280F, 350.0F, 50.0F, 0.0F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(m51Texture);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, -100.0D, var12, 0, 1);
		var23.addVertexWithUV(var12, -100.0D, var12, 1, 1);
		...
		var12 = 3.6F;
		GL11.glScalef(0.6F, 0.6F, 0.6F);
		GL11.glRotatef(-10.0F, -2.0F, 5.0F, 5.0F);
		GL11.glRotatef(390F, 75.0F, -80.0F, -30.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(polongniusTexture);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, -100.0D, var12, 0, 1);
		var23.addVertexWithUV(var12, -100.0D, var12, 1, 1);
		var23.addVertexWithUV(var12, -100.0D, -var12, 1, 0);
		...
		var12 = 0.4F;
		GL11.glScalef(0.6F, 0.6F, 0.6F);
		GL11.glRotatef(1.0F, 1.0F, 4.0F, 5.0F);
		GL11.glRotatef(-300F, 40.0F, -4.0F, 12.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(fronosTexture);
		var23.startDrawingQuads();
		var23.addVertexWithUV(-var12, -100.0D, var12, 0, 1);
		var23.addVertexWithUV(var12, -100.0D, var12, 1, 1);
		var23.addVertexWithUV(var12, -100.0D, -var12, 1, 0);
	...
	private void renderStars()
	{
		...
		for (int var3 = 0; var3 < (GCCoreConfigManager.moreStars ? 50000 : 6000); ++var3)
		{
