...
public class KoentusBlockRendererTreasureChest implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public KoentusBlockRendererTreasureChest(int var1)
	{
		this.renderID = var1;
	}
	...
	private final KoentusTileEntityTreasureChest chest = new KoentusTileEntityTreasureChest();

	public void renderChest(Block par1Block, int par2, float par3)
	{
		if (par1Block.blockID == KoentusBlocks.koentusTreasureChest.blockID)
		{
