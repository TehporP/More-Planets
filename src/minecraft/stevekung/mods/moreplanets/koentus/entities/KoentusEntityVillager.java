...
public class KoentusEntityVillager extends EntityAgeable implements IEntityBreathable
{
	...
	public KoentusEntityVillager(World par1World)
	{
		super(par1World);
	...
	public KoentusEntityVillager func_90012_b(EntityAgeable par1EntityAgeable)
	{
		final KoentusEntityVillager entityvillager = new KoentusEntityVillager(this.worldObj);
