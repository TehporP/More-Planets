...
public class KoentusEntityDripParticleFX extends EntityFX
{
	private final Material materialType;
	private int bobTimer;

	public KoentusEntityDripParticleFX(World par1World, double par2, double par4, double par6, Material par8Material)
	{
		super(par1World, par2, par4, par6, 0.0D, 0.0D, 0.0D);
		this.motionX = this.motionY = this.motionZ = 0.0D;

		if (par8Material == MorePlanetCore.koentusSludge)
		{
	...
	public void onUpdate()
	{
		...
		if (this.materialType == MorePlanetCore.koentusSludge)
		{
			this.particleGreen = 0.1F;
			this.particleBlue = 0.5F;
			this.particleRed = 0.0F;
