...
public class KoentusEntityMeteorSmokeFX extends EntityFX
{
	...
	public KoentusEntityMeteorSmokeFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
	{
