...
import stevekung.mods.moreplanets.koentus.blocks.KoentusBlockT3TreasureChest;
import cpw.mods.fml.common.FMLCommonHandler;
import cpw.mods.fml.common.network.PacketDispatcher;
import cpw.mods.fml.relauncher.Side;

public class KoentusTileEntityTreasureChest extends GCCoreTileEntityAdvanced implements IInventory, IKeyable
{
	...
	public KoentusTileEntityTreasureChest()
	{
		this(3);
	}

	public KoentusTileEntityTreasureChest(int tier)
	{
		this.tier = tier;
	}
	...
	{
		if (this.getBlockType() != null && this.getBlockType() instanceof KoentusBlockT3TreasureChest)
		{
			--this.numUsingPlayers;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
	...
	{
		return FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT ? StatCollector.translateToLocal("container.koentus.treasurechest.name") : StatCollector.translateToLocal("container.koentus.treasurechest.name");
	}
