...
public class KoentusRoomBoss extends GCCoreDungeonRoom
{
	public int sizeX;
	public int sizeY;
	public int sizeZ;
	...
	public KoentusRoomBoss(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	{
		return new KoentusRoomBoss(dungeon, x, y, z, dir);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		this.worldObj.setBlock(this.spawnerCoords.posX, this.spawnerCoords.posY, this.spawnerCoords.posZ, KoentusBlocks.koentusBasicBlock.blockID, 13, 3);
