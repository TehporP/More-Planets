...
public class KoentusComponentVillageField2 extends KoentusComponentVillage
{
	...
	public KoentusComponentVillageField2()
	{
	}

	public KoentusComponentVillageField2(KoentusComponentVillageStartPiece par1ComponentVillageStartPiece, int par2, Random par3Random, StructureBoundingBox par4StructureBoundingBox, int par5)
	{
	...
	public static KoentusComponentVillageField2 func_74900_a(KoentusComponentVillageStartPiece par0ComponentVillageStartPiece, List par1List, Random par2Random, int par3, int par4, int par5, int par6, int par7)
	{
		...
		return KoentusComponentVillage.canVillageGoDeeper(structureboundingbox) && StructureComponent.findIntersecting(par1List, structureboundingbox) == null ? new KoentusComponentVillageField2(par0ComponentVillageStartPiece, par7, par2Random, structureboundingbox, par6) : null;
	}
