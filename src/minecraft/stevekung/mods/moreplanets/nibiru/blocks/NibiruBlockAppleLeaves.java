...
public class NibiruBlockAppleLeaves extends BlockLeavesBase implements IShearable
{
	public static final String[] types = new String[] {"leavesDefault",
		"leavesFlower",
		"leavesRawApple",
	"leavesApple"};
	...
	public NibiruBlockAppleLeaves(int blockID)
	{
	...
	public boolean onBlockActivated (World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
	{
		...
		if ((meta & 3) == 3)
		{
			...
			EntityItem entityitem = new EntityItem(world, x, y, z, new ItemStack(NibiruItems.nibiruFood, 1, 0));
	...
	public void dropBlockAsItemWithChance(World world, int x, int y, int z, int meta, float chance, int par7)
	{
		...
		if ((meta & 3) == 3)
		{
			this.dropBlockAsItem_do(world, x, y, z, new ItemStack(NibiruItems.nibiruFood, 1, 0));
		}
