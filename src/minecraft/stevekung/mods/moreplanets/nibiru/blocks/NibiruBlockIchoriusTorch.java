...
public class NibiruBlockIchoriusTorch extends BlockTorch
{
	public NibiruBlockIchoriusTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("nibiru:ichoriusTorch");
	}
	...
	public void randomDisplayTick(World par1World, int par2, int par3, int par4, Random par5Random)
	{
		...
		if (l == 1)
		{
			...
			MorePlanetCore.proxy.spawnParticle("ichoriusSmoke", d0 - d4, d1 + d3, d2);
		}
		else if (l == 2)
		{
			par1World.spawnParticle("smoke", d0 + d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
		...
		else if (l == 3)
		{
			...
			MorePlanetCore.proxy.spawnParticle("ichoriusSmoke", d0, d1 + d3, d2 - d4);
		}
		else if (l == 4)
		{
			par1World.spawnParticle("smoke", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
		...
		else
		{
			...
			MorePlanetCore.proxy.spawnParticle("ichoriusSmoke", d0, d1, d2);
		}
	}
