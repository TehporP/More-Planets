...
public class NibiruBlockInfectedVine extends Block implements IShearable
{
	public NibiruBlockInfectedVine(int par1)
	{
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity)
	{
		if (!world.isRemote && entity instanceof EntityLivingBase)
		{
			if (entity instanceof EntityPlayer)
			{
				...
				if (!(inventory.armorInventory[0] != null && inventory.armorInventory[0].itemID == Item.bootsLeather.itemID && inventory.armorInventory[1] != null && inventory.armorInventory[1].itemID == Item.legsLeather.itemID && inventory.armorInventory[2] != null && inventory.armorInventory[2].itemID == Item.plateLeather.itemID && inventory.armorInventory[3] != null && inventory.armorInventory[3].itemID == Item.helmetLeather.itemID))
				{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("nibiru:infectedVine");
	}
}