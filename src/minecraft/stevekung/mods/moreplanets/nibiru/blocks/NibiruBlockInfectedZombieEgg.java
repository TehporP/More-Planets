...
public class NibiruBlockInfectedZombieEgg extends BlockDragonEgg
{
	public NibiruBlockInfectedZombieEgg(int par1)
	{
		super(par1);
	...
	{
		this.blockIcon = iconRegister.registerIcon("nibiru:infectedZombieEgg");
	}
