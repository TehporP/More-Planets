...
public class NibiruBlockOrangeLeaves extends BlockLeavesBase implements IShearable
{
	public static final String[] types = new String[] {"leaves2Default",
		"leaves2Flower",
		"leaves2RawOrange",
	"leaves2Orange"};
	...
	public NibiruBlockOrangeLeaves(int blockID)
	{
	...
	public boolean onBlockActivated (World world, int x, int y, int z, EntityPlayer player, int par6, float par7, float par8, float par9)
	{
		...
		if ((meta & 3) == 3)
		{
			world.setBlock(x, y, z, this.blockID, meta - 3, 3);
			EntityItem entityitem = new EntityItem(world, x, y, z, new ItemStack(NibiruItems.nibiruFood, 1, 1));
	...
	{
		return NibiruBlocks.nibiruBlockSapling.blockID;
	}
	...
	public void dropBlockAsItemWithChance(World world, int x, int y, int z, int meta, float chance, int par7)
	{
		...
		if ((meta & 3) == 3)
		{
			this.dropBlockAsItem_do(world, x, y, z, new ItemStack(NibiruItems.nibiruFood, 1, 1));
		}
