...
public class NibiruSkyProvider extends IRenderHandler
{
	...
	{
		NibiruWorldProvider gcProvider = null;

		if (world.provider instanceof NibiruWorldProvider)
		{
			gcProvider = (NibiruWorldProvider) world.provider;
		}

		GL11.glDisable(GL11.GL_TEXTURE_2D);
		final Vec3 var2 = this.getCustomSkyColor();
		float var3 = (float) var2.xCoord * (1 - world.getStarBrightness(partialTicks) * 5);
		float var4 = (float) var2.yCoord * (1 - world.getStarBrightness(partialTicks) * 5);
		float var5 = (float) var2.zCoord * (1 - world.getStarBrightness(partialTicks) * 5);
		float var8;
		...
		if (var20 > 0.0F)
		{
			GL11.glColor4f(3.5F, 3.5F, 3.5F, var20);
		...
		GL11.glRotatef(200F, 20.0F, 0.0F, 10.0F);
		...
		/**@PinwheelGalaxy**/
		var12 = 10.0F;
		final float galaxyRotation = (float) (world.getSpawnPoint().posZ - mc.thePlayer.posZ) * 0.01F;
		GL11.glRotatef(galaxyRotation, 1.0F, 10.0F, 10.0F);
		GL11.glRotatef(120F, -120.0F, -100.0F, -40.0F);
		GL11.glColor4f(1.0F, 1.0F, 1.0F, 1F);
	...
	private void renderStars()
	{
		...
		for (int var3 = 0; var3 < (GCCoreConfigManager.moreStars ? 70000 : 6000); ++var3)
		{
