...
public class NibiruBlockRendererAncientChest implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public NibiruBlockRendererAncientChest(int var1)
	{
		this.renderID = var1;
	}
	...
	private final NibiruTileEntityAncientChest chest = new NibiruTileEntityAncientChest();

	public void renderChest(Block par1Block, int par2, float par3)
	{
		if (par1Block.blockID == NibiruBlocks.nibiruAncientChest.blockID)
		{
