...
public class NibiruBlockRendererTreasureChest implements ISimpleBlockRenderingHandler
{
	final int renderID;

	public NibiruBlockRendererTreasureChest(int var1)
	{
		this.renderID = var1;
	}
	...
	private final NibiruTileEntityTreasureChest chest = new NibiruTileEntityTreasureChest();

	public void renderChest(Block par1Block, int par2, float par3)
	{
		if (par1Block.blockID == NibiruBlocks.nibiruTreasureChest.blockID)
		{
