...
public class NibiruRenderInfectionDart extends Render
{
	private static final ResourceLocation arrowTextures = new ResourceLocation("nibiru:textures/model/infectionDart.png");

	public void renderArrow(NibiruEntityInfectionDart par1EntityArrow, double par2, double par4, double par6, float par8, float par9)
	{
	...
	protected ResourceLocation getArrowTextures(NibiruEntityInfectionDart par1EntityArrow)
	{
	...
	{
		return this.getArrowTextures((NibiruEntityInfectionDart)par1Entity);
	}

	@Override
	public void doRender(Entity par1Entity, double par2, double par4, double par6, float par8, float par9)
	{
		this.renderArrow((NibiruEntityInfectionDart)par1Entity, par2, par4, par6, par8, par9);
	}
}