...
package stevekung.mods.moreplanets.nibiru.core.render.gui;

import micdoodle8.mods.galacticraft.api.world.ICelestialBodyRenderer;
import net.minecraft.client.renderer.Tessellator;
import net.minecraft.util.ResourceLocation;

public class NibiruSlotGuiRenderer implements ICelestialBodyRenderer
{
	@Override
	...
	{
		return new ResourceLocation("nibiru:textures/gui/planets/nibiru.png");
	}
