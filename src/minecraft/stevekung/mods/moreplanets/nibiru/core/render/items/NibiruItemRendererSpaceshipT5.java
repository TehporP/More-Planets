...
package stevekung.mods.moreplanets.nibiru.core.render.items;
...
public class NibiruItemRendererSpaceshipT5 extends GCCoreItemRendererSpaceship
{
	private static final ResourceLocation cargoRocketTexture = new ResourceLocation("nibiru:textures/model/rocketT5.png");
	private ModelBase cargoRocketModel;

	public NibiruItemRendererSpaceshipT5(ModelBase cargoRocketModel)
	{
		super(new NibiruEntityRocketT5(FMLClientHandler.instance().getClient().theWorld), new MPModelSpaceship(), new ResourceLocation("nibiru:textures/model/rocketT5.png"));
	...
	public void transform(ItemStack itemstack, ItemRenderType type)
	{
		...
		if (type == ItemRenderType.EQUIPPED)
		{
			...
			if (player != null && player.ridingEntity != null && player.ridingEntity instanceof NibiruEntityRocketT5)
			{
