...
public class NibiruEntityRocketT5 extends EntityTieredRocket
{
	public IUpdatePlayerListBox rocketSoundUpdater;

	public NibiruEntityRocketT5(World par1World)
	{
		super(par1World);
	}

	public NibiruEntityRocketT5(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
	{
	...
	public NibiruEntityRocketT5(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		droppedItems.add(new ItemStack(NibiruItems.rocketT5, 1, this.rocketType.getIndex()));
		return droppedItems;
	}
}