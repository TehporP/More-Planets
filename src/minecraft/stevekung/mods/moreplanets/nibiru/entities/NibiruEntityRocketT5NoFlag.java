...
public class NibiruEntityRocketT5NoFlag extends EntityTieredRocket
{
	public IUpdatePlayerListBox rocketSoundUpdater;

	public NibiruEntityRocketT5NoFlag(World par1World)
	{
		super(par1World);
	}

	public NibiruEntityRocketT5NoFlag(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
	{
	...
	public NibiruEntityRocketT5NoFlag(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public void onTeleport(EntityPlayerMP player)
	{
		...
		if (playerBase != null)
		{
			...
			playerBase.setRocketItem(NibiruItems.rocketT5);
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		droppedItems.add(new ItemStack(NibiruItems.rocketT5, 1, this.rocketType.getIndex() + 10));
		return droppedItems;
	}
}