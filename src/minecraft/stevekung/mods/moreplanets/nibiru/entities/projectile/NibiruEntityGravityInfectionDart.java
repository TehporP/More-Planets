...
package stevekung.mods.moreplanets.nibiru.entities.projectile;
...
public class NibiruEntityGravityInfectionDart extends Entity
{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public NibiruEntityGravityInfectionDart(World par1World)
	{
		super(par1World);
		this.setSize(0.5F, 0.5F);
	}

	public NibiruEntityGravityInfectionDart(World par1World, double par2, double par4, double par6)
	{
		super(par1World);
		this.setSize(0.5F, 0.5F);
	...
	public NibiruEntityGravityInfectionDart(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving, float par4, float par5)
	{
		super(par1World);
	...
	public NibiruEntityGravityInfectionDart(World par1World, EntityLivingBase par2EntityLiving, float par3)
	{
		super(par1World);
		this.shootingEntity = par2EntityLiving;
		...
		else
		{
			...
			if (var4 != null)
			{
				if (var4.entityHit != null)
				{
					...
					{
						var22 = MPDamageSource.causeGravityInfectionDartDamage(this, this);
					}
					else
					{
						var22 = MPDamageSource.causeGravityInfectionDartDamage(this, this.shootingEntity);
					}
