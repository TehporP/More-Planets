...
public class NibiruEntityInfectionDart extends Entity implements IProjectile
{
	private int xTile = -1;
	private int yTile = -1;
	private int zTile = -1;
	...
	public NibiruEntityInfectionDart(World par1World)
	{
		super(par1World);
	...
	public NibiruEntityInfectionDart(World par1World, double par2, double par4, double par6)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.setSize(0.5F, 0.5F);
	...
	public NibiruEntityInfectionDart(World par1World, EntityLivingBase par2EntityLivingBase, EntityLivingBase par3EntityLivingBase, float par4, float par5)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
	...
	public NibiruEntityInfectionDart(World par1World, EntityLivingBase par2EntityLivingBase, float par3)
	{
		super(par1World);
		this.renderDistanceWeight = 10.0D;
		this.shootingEntity = par2EntityLivingBase;
		...
		else
		{
			...
			if (movingobjectposition != null)
			{
				if (movingobjectposition.entityHit != null)
				{
					...
					{
						damagesource = MPDamageSource.causeInfectionDartDamage(this, this);
					}
					else
					{
						damagesource = MPDamageSource.causeInfectionDartDamage(this, this.shootingEntity);
					}
