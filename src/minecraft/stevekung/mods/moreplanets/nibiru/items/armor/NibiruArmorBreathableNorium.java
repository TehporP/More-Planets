...
public class NibiruArmorBreathableNorium extends ItemArmor implements IBreathableArmor
{
	public NibiruArmorBreathableNorium(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
	...
	{
		if (stack.itemID == NibiruArmorItems.breathableNoriumHelmet.itemID)
		{
			return "nibiru:textures/model/armor/breathableNorium_1.png";
		}
		return null;
	}
	...
	{
		if (par1ItemStack.itemID == NibiruArmorItems.breathableNoriumHelmet.itemID)
		{
			return true;
		}
		return false;
