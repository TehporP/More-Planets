...
public class NibiruArmorNorium extends ItemArmor
{
	public NibiruArmorNorium(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
	...
	{
		if (stack.itemID == NibiruArmorItems.noriumHelmet.itemID || stack.itemID == NibiruArmorItems.noriumChestplate.itemID || stack.itemID == NibiruArmorItems.noriumBoots.itemID)
		{
			return "nibiru:textures/model/armor/norium_1.png";
		}
		if (stack.itemID == NibiruArmorItems.noriumLeggings.itemID)
		{
