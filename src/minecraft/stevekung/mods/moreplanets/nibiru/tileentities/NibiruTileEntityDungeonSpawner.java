...
public class NibiruTileEntityDungeonSpawner extends GCCoreTileEntityDungeonSpawner
{
	public NibiruTileEntityDungeonSpawner()
	{
		super(NibiruEntityGiantSpikeBoss.class);
	}
