...
import stevekung.mods.moreplanets.nibiru.blocks.NibiruBlockT5TreasureChest;
import cpw.mods.fml.common.FMLCommonHandler;
import cpw.mods.fml.common.network.PacketDispatcher;
import cpw.mods.fml.relauncher.Side;

public class NibiruTileEntityTreasureChest extends GCCoreTileEntityAdvanced implements IInventory, IKeyable
{
	...
	public NibiruTileEntityTreasureChest()
	{
		this(5);
	}

	public NibiruTileEntityTreasureChest(int tier)
	{
		this.tier = tier;
	}
	...
	{
		if (this.getBlockType() != null && this.getBlockType() instanceof NibiruBlockT5TreasureChest)
		{
			--this.numUsingPlayers;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
	...
	{
		return FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT ? StatCollector.translateToLocal("container.nibiru.treasurechest.name") : StatCollector.translateToLocal("container.nibiru.treasurechest.name");
	}
