...
public class NibiruWorldGenAppleTree extends WorldGenerator
{
	@Override
			...
			} else
			{
				...
				if ((var8 == NibiruBlocks.infectedGrass.blockID || var8 == NibiruBlocks.infectedDirt.blockID) && par4 < 256 - var6 - 1)
				{
						...
						for (var12 = par3 - var11; var12 <= par3 + var11; ++var12)
						{
							...
							for (int var14 = par5 - var11; var14 <= par5 + var11; ++var14)
							{
								...
								if ((Math.abs(var13) != var11 || Math.abs(var15) != var11 || par2Random.nextInt(2) != 0 && var10 != 0) && !Block.opaqueCubeLookup[par1World.getBlockId(var12, var16, var14)])
								{
									...
									if (var99 == 44)
									{
										this.setBlockAndMetadata(par1World, var12, var16, var14, NibiruBlocks.nibiruAppleLeaves.blockID, 3);
									}
									else if (var99 == 30)
									{
										this.setBlockAndMetadata(par1World, var12, var16, var14, NibiruBlocks.nibiruAppleLeaves.blockID, 2);
									}
									else if (var99 == 15)
									{
										this.setBlockAndMetadata(par1World, var12, var16, var14, NibiruBlocks.nibiruAppleLeaves.blockID, 2);
									...
									{
										this.setBlockAndMetadata(par1World, var12, var16, var14, NibiruBlocks.nibiruAppleLeaves.blockID, 1);
									}
									else if (var99 == 5)
									{
										this.setBlockAndMetadata(par1World, var12, var16, var14, NibiruBlocks.nibiruAppleLeaves.blockID, 1);
									...
									{
										this.setBlockAndMetadata(par1World, var12, var16, var14, NibiruBlocks.nibiruAppleLeaves.blockID, 0);
									}
								}
							}
						}
					...
					for (var16 = 0; var16 < var6; ++var16)
					{
						...
						{
							this.setBlockAndMetadata(par1World, par3, par4 + var16, par5, NibiruBlocks.nibiruBlockWood.blockID, 0);
						}
					}
