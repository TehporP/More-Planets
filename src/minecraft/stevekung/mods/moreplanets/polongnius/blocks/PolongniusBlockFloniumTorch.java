...
public class PolongniusBlockFloniumTorch extends BlockTorch
{
	public PolongniusBlockFloniumTorch(int id)
	{
		super(id);
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("polongnius:floniumTorch");
	}
