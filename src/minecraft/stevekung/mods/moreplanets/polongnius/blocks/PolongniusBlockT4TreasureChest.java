...
public class PolongniusBlockT4TreasureChest extends BlockContainer implements ITileEntityProvider
{
	private final Random random = new Random();

	public PolongniusBlockT4TreasureChest(int id)
	{
	...
	{
		this.blockIcon = par1IconRegister.registerIcon("polongnius:polongniusTreasureChest");
	}
	...
	{
		final PolongniusTileEntityTreasureChest var7 = (PolongniusTileEntityTreasureChest) par1World.getBlockTileEntity(par2, par3, par4);
	...
	public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
	{
		...
		else if (PolongniusBlockT4TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4))
		{
			return true;
		}
		else if (par1World.getBlockId(par2 - 1, par3, par4) == this.blockID && (par1World.isBlockSolidOnSide(par2 - 1, par3 + 1, par4, ForgeDirection.DOWN) || PolongniusBlockT4TreasureChest.isOcelotBlockingChest(par1World, par2 - 1, par3, par4)))
		{
			return true;
		}
		else if (par1World.getBlockId(par2 + 1, par3, par4) == this.blockID && (par1World.isBlockSolidOnSide(par2 + 1, par3 + 1, par4, ForgeDirection.DOWN) || PolongniusBlockT4TreasureChest.isOcelotBlockingChest(par1World, par2 + 1, par3, par4)))
		...
		else if (par1World.getBlockId(par2, par3, par4 - 1) == this.blockID && (par1World.isBlockSolidOnSide(par2, par3 + 1, par4 - 1, ForgeDirection.DOWN) || PolongniusBlockT4TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 - 1)))
		{
			return true;
		}
		else if (par1World.getBlockId(par2, par3, par4 + 1) == this.blockID && (par1World.isBlockSolidOnSide(par2, par3 + 1, par4 + 1, ForgeDirection.DOWN) || PolongniusBlockT4TreasureChest.isOcelotBlockingChest(par1World, par2, par3, par4 + 1)))
	...
	{
		return new PolongniusTileEntityTreasureChest(4);
	}
