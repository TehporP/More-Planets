...
public class PolongniusSkyProvider extends IRenderHandler
{
	...
	{
		PolongniusWorldProvider gcProvider = null;

		if (world.provider instanceof PolongniusWorldProvider)
		{
			gcProvider = (PolongniusWorldProvider) world.provider;
		}
		...
		GL11.glRotatef(250F, 1.2F, 0.0F, 1.0F);
		...
		GL11.glRotatef(220F, 20.0F, 80.0F, 0.0F);
