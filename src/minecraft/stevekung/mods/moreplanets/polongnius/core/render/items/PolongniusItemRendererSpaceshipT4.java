...
package stevekung.mods.moreplanets.polongnius.core.render.items;
...
public class PolongniusItemRendererSpaceshipT4 extends GCCoreItemRendererSpaceship
{
	private static final ResourceLocation cargoRocketTexture = new ResourceLocation("polongnius:textures/model/rocketT4.png");
	private ModelBase cargoRocketModel;

	public PolongniusItemRendererSpaceshipT4(ModelBase cargoRocketModel)
	{
		super(new PolongniusEntityRocketT4(FMLClientHandler.instance().getClient().theWorld), new MPModelSpaceship(), new ResourceLocation("polongnius:textures/model/rocketT4.png"));
	...
	public void transform(ItemStack itemstack, ItemRenderType type)
	{
		...
		if (type == ItemRenderType.EQUIPPED)
		{
			...
			if (player != null && player.ridingEntity != null && player.ridingEntity instanceof PolongniusEntityRocketT4)
			{
