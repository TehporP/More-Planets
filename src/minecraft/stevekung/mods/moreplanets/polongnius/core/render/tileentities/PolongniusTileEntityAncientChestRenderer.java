...
public class PolongniusTileEntityAncientChestRenderer extends TileEntitySpecialRenderer
{
	...
	private static final ResourceLocation chestNormal = new ResourceLocation("polongnius:textures/model/polongniusAncientChest.png");
	private static final ResourceLocation largeChestNormal = new ResourceLocation("polongnius:textures/model/polongniusAncientChestLarge.png");;
	...
	public PolongniusTileEntityAncientChestRenderer()
	{
	...
	public void renderTileEntityChestAt(PolongniusTileEntityAncientChest par1TileEntityChest, double par2, double par4, double par6, float par8)
	{
		int i;
		...
		else
		{
			...
			if (block instanceof PolongniusBlockAncientChest && i == 0)
			{
				try
				{
					((PolongniusBlockAncientChest)block).unifyAdjacentChests(par1TileEntityChest.getWorldObj(), par1TileEntityChest.xCoord, par1TileEntityChest.yCoord, par1TileEntityChest.zCoord);
				}
	...
	{
		this.renderTileEntityChestAt((PolongniusTileEntityAncientChest)par1TileEntity, par2, par4, par6, par8);
	}
}