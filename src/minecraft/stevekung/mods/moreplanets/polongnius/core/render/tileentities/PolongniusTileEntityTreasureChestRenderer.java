...
public class PolongniusTileEntityTreasureChestRenderer extends TileEntitySpecialRenderer
{
	private static final ResourceLocation treasureChestTexture = new ResourceLocation("polongnius:textures/model/polongniusTreasureChest.png");

	private final GCCoreModelTreasureChest chestModel = new GCCoreModelTreasureChest();

	public void renderGCTileEntityTreasureChestAt(PolongniusTileEntityTreasureChest par1TreasureChest, double par2, double par4, double par6, float par8)
	{
		int var9;
		...
		this.bindTexture(PolongniusTileEntityTreasureChestRenderer.treasureChestTexture);
	...
	{
		this.renderGCTileEntityTreasureChestAt((PolongniusTileEntityTreasureChest) par1TileEntity, par2, par4, par6, par8);
	}
}