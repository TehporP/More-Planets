...
public class PolongniusEntityCheeseSlime extends EntityLiving implements IMob, IEntityBreathable
{
	...
	public PolongniusEntityCheeseSlime(World par1World)
	{
		super(par1World);
		int i = 1 << this.rand.nextInt(4);
		this.yOffset = 0.0F;
	...
	public void onUpdate()
	{
		...
		if (this.onGround && !flag)
		{
			...
			for (int j = 0; j < i * 8; ++j)
			{
				...
				MorePlanetCore.proxy.spawnParticle("cheeseSlime", this.posX + f2, this.boundingBox.minY, this.posZ + f3);
			}
	...
	protected PolongniusEntityCheeseSlime createInstance()
	{
		return new PolongniusEntityCheeseSlime(this.worldObj);
	}
	...
	public void setDead()
	{
		...
		if (!this.worldObj.isRemote && i > 1 && this.getHealth() <= 0.0F)
		{
			...
			for (int k = 0; k < j; ++k)
			{
				...
				PolongniusEntityCheeseSlime entityslime = this.createInstance();
	...
	{
		return this.getSlimeSize() == 1 ? PolongniusItems.cheeseSlimeball.itemID : 0;
	}
