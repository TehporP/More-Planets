...
public class PolongniusEntityRocketT4 extends EntityTieredRocket
{
	public IUpdatePlayerListBox rocketSoundUpdater;

	public PolongniusEntityRocketT4(World par1World)
	{
		super(par1World);
	}

	public PolongniusEntityRocketT4(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
	{
	...
	public PolongniusEntityRocketT4(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		droppedItems.add(new ItemStack(PolongniusItems.rocketTier4, 1, this.rocketType.getIndex()));
		return droppedItems;
	}
}