...
public class PolongniusEntityRocketT4NoFlag extends EntityTieredRocket
{
	public IUpdatePlayerListBox rocketSoundUpdater;

	public PolongniusEntityRocketT4NoFlag(World par1World)
	{
		super(par1World);
	}

	public PolongniusEntityRocketT4NoFlag(World par1World, double par2, double par4, double par6, EnumRocketType rocketType)
	{
	...
	public PolongniusEntityRocketT4NoFlag(World par1World, double par2, double par4, double par6, boolean reversed, EnumRocketType rocketType, ItemStack[] inv)
	{
	...
	public void onTeleport(EntityPlayerMP player)
	{
		...
		if (playerBase != null)
		{
			...
			playerBase.setRocketType(this.rocketType.getIndex() + 10);
			playerBase.setRocketItem(PolongniusItems.rocketTier4);
	...
	public List<ItemStack> getItemsDropped(List<ItemStack> droppedItems)
	{
		...
		droppedItems.add(new ItemStack(PolongniusItems.rocketTier4, 1, this.rocketType.getIndex() + 10));
		return droppedItems;
	}
}