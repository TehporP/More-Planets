...
public class PolongniusArmorBreathableMeteor extends ItemArmor implements IBreathableArmor
{
	public PolongniusArmorBreathableMeteor(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
	...
	{
		if (stack.itemID == PolongniusArmorItems.breathablePolongniusMeteorHelmet.itemID)
		{
			return "polongnius:textures/model/armor/breathablePolongniusMeteor_1.png";
		}
		return null;
	}
	...
	{
		if (par1ItemStack.itemID == PolongniusArmorItems.breathablePolongniusMeteorHelmet.itemID)
		{
			return true;
		}
		return false;
