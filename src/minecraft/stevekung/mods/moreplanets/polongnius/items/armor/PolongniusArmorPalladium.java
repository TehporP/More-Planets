...
public class PolongniusArmorPalladium extends ItemArmor
{
	public PolongniusArmorPalladium(int par1, EnumArmorMaterial par2EnumArmorMaterial, int par3, int par4)
	{
	...
	{
		if (stack.getItem() == PolongniusArmorItems.palladiumHelmet || stack.getItem() == PolongniusArmorItems.palladiumChestplate || stack.getItem() == PolongniusArmorItems.palladiumBoots)
		{
			return "polongnius:textures/model/armor/palladium_1.png";
		}
		if (stack.itemID == PolongniusArmorItems.palladiumLeggings.itemID)
		{
