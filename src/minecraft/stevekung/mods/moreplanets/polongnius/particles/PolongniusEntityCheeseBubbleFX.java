...
package stevekung.mods.moreplanets.polongnius.particles;
...
public class PolongniusEntityCheeseBubbleFX extends EntityFX
{
	private static final String texture = "polongnius:textures/particles/cheeseBubble.png";

	float steamParticleScale;

	public PolongniusEntityCheeseBubbleFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12)
	{
		this(par1World, par2, par4, par6, par8, par10, par12, 1.0F);
	}

	public PolongniusEntityCheeseBubbleFX(World par1World, double par2, double par4, double par6, double par8, double par10, double par12, float par14)
	{
	...
	public void renderParticle(Tessellator tessellator, float par2, float par3, float par4, float par5, float par6, float par7)
	{
		...
		FMLClientHandler.instance().getClient().renderEngine.bindTexture(new ResourceLocation(PolongniusEntityCheeseBubbleFX.texture));
