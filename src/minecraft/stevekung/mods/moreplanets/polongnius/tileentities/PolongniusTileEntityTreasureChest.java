...
import stevekung.mods.moreplanets.polongnius.blocks.PolongniusBlockT4TreasureChest;
import cpw.mods.fml.common.FMLCommonHandler;
import cpw.mods.fml.common.network.PacketDispatcher;
import cpw.mods.fml.relauncher.Side;

public class PolongniusTileEntityTreasureChest extends GCCoreTileEntityAdvanced implements IInventory, IKeyable
{
	...
	public PolongniusTileEntityTreasureChest()
	{
		this(4);
	}

	public PolongniusTileEntityTreasureChest(int tier)
	{
		this.tier = tier;
	}
	...
	{
		if (this.getBlockType() != null && this.getBlockType() instanceof PolongniusBlockT4TreasureChest)
		{
			--this.numUsingPlayers;
			this.worldObj.addBlockEvent(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID, 1, this.numUsingPlayers);
			this.worldObj.notifyBlocksOfNeighborChange(this.xCoord, this.yCoord, this.zCoord, this.getBlockType().blockID);
	...
	{
		return FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT ? StatCollector.translateToLocal("container.polongnius.treasurechest.name") : StatCollector.translateToLocal("container.polongnius.treasurechest.name");
	}
