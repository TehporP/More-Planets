...
public class PolongniusRoomChests extends GCCoreDungeonRoom
{
	int sizeX;
	int sizeY;
	int sizeZ;
	...
	public PolongniusRoomChests(GCCoreMapGenDungeon dungeon, int posX, int posY, int posZ, ForgeDirection entranceDir)
	{
	...
	public void generate(short[] chunk, byte[] meta, int cx, int cz)
	{
		...
		if (this.placeBlock(chunk, meta, hx, this.posY, hz, cx, cz, PolongniusBlocks.polongniusAncientChest.blockID, 0))
		{
	...
	{
		return new PolongniusRoomChests(dungeon, x, y, z, dir);
	}
	...
	protected void handleTileEntities(Random rand)
	{
		...
		{
			this.worldObj.setBlock(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ, PolongniusBlocks.polongniusAncientChest.blockID, 0, 2);
			PolongniusTileEntityAncientChest chest = (PolongniusTileEntityAncientChest) this.worldObj.getBlockTileEntity(this.chests.get(0).posX, this.chests.get(0).posY, this.chests.get(0).posZ);
